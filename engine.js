//game engine code written in javascript to ensure that all games will run at the same framerate across all devices
...
const Engine = function(time_step, update, render) {
    ...
    this.run = function(time_stamp) {
        ...
        while(this.accumulated_time >= this.time_step){
            ...
            this.updated = true;//if the game has updated, draw again 
            
        }
        
        //will only draw when game has updated
        if(this.updated) {
